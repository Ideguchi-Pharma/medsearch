...
return (
    <div className="p-8">
        ...
        <div className="
            flex flex-row  justify-start mt-4
            space-x-2 px-4 py-2 rounded-2xl w-full info-bg
            ">
             <InformationCircleIcon className="items-start justify-start pt-1 h-8 w-8 text-cyan-500 dark:text-white" />
        ...
        <div className="flex flex-col pt-10 px-6">
            <h2 className="text-2xl font-bold mb-6">2. 薬局の施設登録（登録無料）</h2>
        ...
        <div className="flex flex-col pt-10 px-6">
            <h2 className="text-2xl font-bold mb-6">3. レセプトファイルから在庫状況の登録</h2>
        ...
        <div className="flex flex-col pt-10 px-6 pb-4">
            ...
            {serviceMenu.links.map((link => (
                <div key={link.id} className="flex items-center gap-x-8 p-2">
                    <div className="w-8">
                        {link.id}
                    </div>
